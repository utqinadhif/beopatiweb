...
<div class="col-lg-8 col-md-12 clearfix mb-5 left-content">
	<div class="box-category">
		<div class="post-head">
			<h4><i class="cificon licon-file-text mr-1"></i> Index Post</h4>
		</div>
						...
						<div class="col-md-8">
							<div class="media-body post-info">
								...
								<ul class="entry-meta clearfix">
									<li>
										<i class="cificon licon-calendar"></i> <?php echo ci_date($res['datepost'].$res['timepost'], 'd F Y | H:i');?>
									</li>
									<li>
										<i class="cificon licon-folder"></i> <a href="<?php echo site_url('category/'.$res['category_seotitle']);?>"><?php echo $res['category_title'];?></a>
									</li>
								</ul>
								<!--/ meta -->
