			...
			<div class="d-flex justify-content-between">
				<div class="clearfix">
					<div class="breadcrumb pd-0 pd-b-10 mg-0">
						...
						<a href="#" class="breadcrumb-item"><?php echo lang_line('_edit_group');?></a>
					</div>
					<h4 class="pd-0 mg-0 tx-20 tx-dark tx-spacing--1"><?php echo lang_line('_edit_group');?></h4>
				</div>
			</div>
		</div>
		<div class="mg-t-15">
	...
	<div class="card">
		...
		<div class="card-body">
			<div class="form-group">
				...
				<input id="title" type="text" name="title" class="form-control" value="<?php echo $res_group['title'];?>" />
			</div>
			<div class="form-group mb-0">
				<label><?php echo lang_line('_group');?> <span class="text-danger">*</span></label>
				<input id="group" type="text" name="group" class="form-control" value="<?php echo $res_group['group'];?>" />
			</div>
		</div>
