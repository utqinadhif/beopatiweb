				...
				<table id="DataTable" class="table table-striped table-bordered">
					<thead>
						<tr>
							...
							<th><?php echo lang_line('_seotitle');?></th>
							<th><?php echo lang_line('_parent');?></th>
					...
					<tfoot>
						<tr>
							<td colspan="7">
								<button type="button" class="btn btn-sm btn-danger delete_multi">
									<?php echo lang_line('button_delete_selected_item');?>
								</button>
							</td>
						</tr>
					</tfoot>
