...
<div class="page-inner p-settings mg-b-70">
	<div class="d-sm-flex align-items-center justify-content-between pd-b-20">
			...
			<div class="d-flex justify-content-between">
				<div class="clearfix">
					<div class="breadcrumb pd-0 pd-b-10 mg-0">
						...
						<a href="#" class="breadcrumb-item"><?php echo lang_line('ui_apperance');?></a>
		...
		<div class="mg-t-15">
			<button type="button" class="btn btn-sm pd-x-15 btn-white btn-uppercase" onclick="window.location='<?php echo admin_url($this->mod.'/lists');?>'"><i data-feather="grid" class="mr-2"></i><?php echo lang_line('button_list_settings');?></button>
		</div>
	</div>
	...
	<ul class="nav nav-tabs nav-justified" role="tablist">
		<li class="nav-item">
			<a href="#Tab-General" class="nav-link tx-medium active" data-toggle="tab" style="color:#1b2e4b;"><?php echo lang_line('_general');?></a>
		</li>
		<li class="nav-item">
			<a href="#Tab-Image" class="nav-link tx-medium" data-toggle="tab" style="color:#1b2e4b;"><?php echo lang_line('_image');?></a>
		</li>
		<li class="nav-item">
			<a href="#Tab-Local" class="nav-link tx-medium" data-toggle="tab" style="color:#1b2e4b;"><?php echo lang_line('_local');?></a>
		</li>
		<li class="nav-item">
			<a href="#Tab-Mail" class="nav-link tx-medium" data-toggle="tab" style="color:#1b2e4b;"><?php echo lang_line('_mail');?></a>
		</li>
		<li class="nav-item">
			<a href="#Tab-Config" class="nav-link tx-medium" data-toggle="tab" style="color:#1b2e4b;"><?php echo lang_line('_config');?></a>
		</li>
		<li class="nav-item">
			<a href="#Tab-Other" class="nav-link tx-medium" data-toggle="tab" style="color:#1b2e4b;"><?php echo lang_line('_other');?></a>
		</li>
		<li class="nav-item">
			<a href="#Tab-MetaSocial" class="nav-link tx-medium" data-toggle="tab" style="color:#1b2e4b;"><?php echo lang_line('_metasocial');?></a>
		</li>
		<?php if (group_active()=='root'): ?>
		<li class="nav-item">
			<a href="#Tab-Backup" class="nav-link tx-medium" data-toggle="tab" style="color:#1b2e4b;"><?php echo lang_line('_backup');?></a>
		</li>
		<?php endif ?>
	</ul>
	...
	<div class="tab-content bd bd-gray-400 bd-t-0 pd-20 bg-white">
		...
		<div id="Tab-MetaSocial" class="tab-pane fadeX showX ">
			<div class="box-body">
				...
				<button type="button" id="submit-meta" class="btn btn-lg btn-success mt-2"><i class="fa fa-save mr-2"></i><?php echo lang_line('button_save_metasocial');?></button>
		...
		<div id="Tab-Backup" class="tab-pane">
			...
			<div class="box-body">
				...
				<div class="card">
					...
					?>
					<div class="card-body">
						<label class="tx-sans tx-10 tx-medium tx-spacing-1 tx-uppercase tx-color-03 mg-b-10"><?php echo lang_line('_webz');?></label>
						<div class="row">
							<div class="col-md-12 mg-b-30">
								<input id="c_webz" type="checkbox" name="web" value="1" class="c_data mr-1"> <label for="c_webz"><?php echo lang_line('_webzdata');?></label>
							</div>
						</div>
						
						<label class="tx-sans tx-10 tx-medium tx-spacing-1 tx-uppercase tx-color-03 mg-b-15"><?php echo lang_line('_database');?></label>
						<div class="row">
							<?php
						...
						<div class="text-center">
							<div class="form-group mb-0">
								...
								<label for="select-allz" class="mb-0 ml-1"><?php echo lang_line('ui_select_all');?></label>
							</div>
						</div>
					</div>
					<div id="btnBackupz" class="card-footer text-center" style="display:none;">
						<button type="submit" class="button_backup btn btn-lg btn-primary"><i class="fa fa-save mr-2"></i><?php echo lang_line("button_backup");?></button>
					</div>
					<?php echo form_close(); ?>
				</div>
			</div>
		...
		<div class="modal-content">
			...
			<div class="modal-body">
				...
				<div class="form-group">
					<label><?php echo lang_line('button_choose_file')?></label>
			...
			<div class="modal-footer">
				<button type="submit" class="btn btn-success"><i class="fa fa-upload mr-2"></i><?php echo lang_line('button_upload');?></button>
			</div>
			<?php echo form_close();?>
		</div>
	</div>
