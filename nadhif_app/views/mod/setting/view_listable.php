			...
			<div class="d-flex justify-content-between">
				<div class="clearfix">
					<div class="breadcrumb pd-0 pd-b-10 mg-0">
						...
						<a href="#" class="breadcrumb-item"><?php echo lang_line('_list_settings');?></a>
					</div>
					<h4 class="pd-0 mg-0 tx-20 tx-dark tx-spacing--1"><?php echo lang_line('_list_settings');?></h4>
				</div>
			</div>
		</div>
		<div class="mg-t-15">
			...
			<button type="button" class="btn btn-sm pd-x-15 btn-white btn-uppercase" onclick="window.location='<?php echo admin_url($this->mod.'/add-list');?>'"><i data-feather="plus" class="mr-2"></i><?php echo lang_line('button_add');?></button>
		</div>
	</div>
				...
				<table id="DataTable" class="table table-striped table-bordered">
					<thead>
						<tr>
							...
							<th><?php echo lang_line('_groups');?></th>
							<th><?php echo lang_line('_options');?></th>
							<th class="no-sort"><?php echo lang_line('_value');?></th>
