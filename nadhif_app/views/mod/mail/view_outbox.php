...
<div class="page-inner">
	...
	<div class="card">
		<div class="card-header">
			...
			<button type="button" onclick="location.href='<?php echo admin_url($this->mod.'/outbox');?>'" class="btn btn-primary"><i data-feather="external-link" class="wd-16"></i><span class="d-none d-lg-inline-block ml-2"><?php echo lang_line('button_outbox');?></span></button>
				...
				<table id="DataTableOut" class="table table-striped table-bordered table-datatable">
					<thead>
						<tr>
							...
							<th><?php echo lang_line('_destination');?></th>
							<th><?php echo lang_line('_subject');?></th>
							<th><?php echo lang_line('_date');?></th>
