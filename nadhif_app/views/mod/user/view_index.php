...
<div class="page-inner">
	<div class="d-sm-flex align-items-center justify-content-between pd-b-20">
		...
		<div class="mg-t-15">
			<button type="button" class="btn btn-sm pd-x-15 btn-white btn-uppercase" onclick="window.location='<?php echo admin_url($this->mod.'/add');?>'"><i data-feather="user-plus" class="mr-2"></i><?php echo lang_line('button_add');?></button>
		</div>
	</div>
				...
				<table id="DataTable" class="table table-striped table-bordered table-datatable">
					<thead>
						<tr>
							...
							<th><?php echo lang_line('_username');?></th>
							<th><?php echo lang_line('_name');?></th>
