...
<div class="page-inner">
	...
	<div class="card mg-b-50">
		<?php echo form_open_multipart('','id="form_add_user" autocomplete="off"');?>
		<div class="card-body">
			<div class="row">
				<!-- Group -->
				...
				<div class="col-md-6 col-lg-3">
					<div class="form-group">
						...
						<div class="input-group">
							...
							<input type="text" id="input-datepicker" name="birthday" class="form-control" aria-label="Date" aria-describedby="basic-date" value="<?php echo date('Y-m-d');?>" />
						</div>
					</div>
				</div>
				<!--/ Birthday -->
		...
		<div class="card-footer">
			<button type="submit" class="btn btn-lg btn-primary submit_add"><i id="submit_icon" class="cificon licon-send mr-2"></i><?php echo lang_line('button_submit');?></button>
		</div>
		<?php echo form_close();?>
	</div>
</div>
