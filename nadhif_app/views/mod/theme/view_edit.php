		...
		<div class="pageheader pd-t-20 pd-b-0">
			<div class="d-flex justify-content-between">
				<div class="clearfix">
					...
					<h4 class="pd-0 mg-0 tx-20 tx-dark tx-spacing--1"><?php echo lang_line('mod_title_edit');?> - <em><?php echo $res_theme['title'];?></em> </h4>
				</div>
			</div>
		</div>
		<div class="mg-t-15">
			...
			<div class="btn-groupX">
				...
				<ul class="nav pull-left mg-r-3">
					<li class="nav-item dropdown">
						<button type="button" class="btn btn-sm btn-white nav-link dropdown-toggle" data-toggle="dropdown"><i class="fa fa-file-text-o mr-2"></i><?php echo $file_layout.".php";?></button>
			...
			<div class="row">
				<div class="col-md-12">
					...
					<div class="block-actions mt-3">
						<button type="submit" class="btn btn-lg btn-primary text-b"><i class="fa fa-save mr-2"></i><?php echo lang_line('button_save');?></button>
					</div>	
					<?php echo form_close();?>
				</div>
			</div>
		...
		<div class="modal-content">
			...
			<div class="modal-body">
				<div class="form-group">
					<label><?php echo lang_line('_filename');?></label>
					<input type="text" name="filename" class="form-control" required/>
				</div>
			</div>
			<div class="modal-footer">
				<button type="submit" class="btn btn-success"><?php echo lang_line('button_submit')?></button>
				<span class="btn btn-default" data-dismiss="modal" aria-hidden="true"><?php echo lang_line('button_cancel')?></span>
			</div>
			<?php echo form_close();?>
		</div>
	</div>
