...
<div class="page-inner">
	<div class="card compogen mg-b-100 mg-t-20">
		...
		<?php echo form_open('', 'class="wizard-form steps-validation" data-fouc');?>
			<!-- Component -->
			...
			<fieldset>
				<div class="card-body" id="step-database">
					...
					<p class="text-center"><button type="button" class="btn btn-xs btn-white btn-add-field" id="5"><i class="fa fa-plus-circle"></i> <?php echo lang_line('button_add_field')?></button></p>
				</div>
			</fieldset>
			<!--/ Database -->
			<!-- Configuration -->
											...
											<div class="col-sm-9">
												<div class="custom-checkbox checkbox-vertical">
													...
													<span class="mr-3">
														...
														<label for="c-Add"><?php echo lang_line('label_conf_add');?></label>
													</span>

													<span class="mr-3">
														<input type="checkbox" id="c-Edit" name="conf[action][edit]" value="1"/>
														<label for="c-Edit"><?php echo lang_line('label_conf_edit');?></label>
													</span>

													<span class="mr-3">
														<input type="checkbox" id="c-Delete" name="conf[action][delete]" value="1"/>
														<label for="c-Delete"><?php echo lang_line('label_conf_delete');?></label>
													</span>
													
													<span class="mr-3">
														<input type="checkbox" id="c-Delete2" name="conf[action][delete_multiple]" value="1"/>
														<label for="c-Delete2"><?php echo lang_line('label_conf_multiple_delete');?></label>
													</span>
												</div>
											</div>
										</div>
			...
			<fieldset>
				<div id="step-finish" class="text-center">
					<?php echo lang_line('mod_setp4_1')?> <a href="javascript:void(0)" class="terms text-primary"><?php echo lang_line('mod_setp4_2')?></a>.
				</div>
			</fieldset>
			<!--/ Finish -->
		<?php echo form_close();?>
	...
	<div class="modal-dialog">
		<div class="modal-content">
			<div class="modal-header">
				<h5 class="modal-title tx-uppercase"><i class="gi gi-pen"></i> <?php echo lang_line('mod_setp4_2')?></h5>
