...
<head>
	...
	<meta name="description" content="<?php echo get_setting('web_description');?>"/>
	<meta name="keyword" content="<?php echo get_setting('web_keyword');?>"/>
	<meta name="author"  content="<?php echo get_setting('web_author');?>"/>
	<title><?php echo $this->CI->meta_title;?> - <?php echo get_setting('web_name');?></title>
	<!-- Favicon -->	
	...
	<link rel="stylesheet" href="<?php echo content_url('plugins/flag/flag-icon.min.css');?>" type="text/css"/>
	<link rel="stylesheet" href="<?php echo content_url('plugins/themify/themify.css');?>" type="text/css"/>
	<link rel="stylesheet" href="<?php echo content_url('plugins/datatable/datatables.min.css');?>"/>
	<link rel="stylesheet" href="<?php echo content_url('plugins/select2/select2.css');?>" type="text/css"/>
	<link rel="stylesheet" href="<?php echo content_url('plugins/bootstrap-tagsinput/bootstrap-tagsinput.css');?>" type="text/css"/>
	...
	<link rel="stylesheet" href="<?php echo content_url('plugins/bootstrap-select/bootstrap-select.min.css');?>" type="text/css"/>
	<link rel="stylesheet" href="<?php echo content_url('plugins/perfect-scrollbar/perfect-scrollbar.css');?>" type="text/css"/>
	<link rel="stylesheet" href="<?php echo content_url('plugins/x-editable/x-editable.css');?>" type="text/css"/>
	<?php
	if($this->mod === 'setting' || $this->mod == 'theme') {
		?>
	...
	if($this->uri->segment(2) == 'menumanager') {
		?>
	...
	<link rel="stylesheet" href="<?php echo content_url('themes/backend/css/skin.light.css');?>" type="text/css"/>
  ...
  csrfData['<?php echo $this->CI->security->get_csrf_token_name();?>'] = '<?php echo $this->CI->security->get_csrf_hash();?>';
	...
	<body>
			...
			<div class="page-sidebar">
				<div class="logo">
					<a href="#" class="logo-img">
						...
						<img class="small-logo" src="<?php echo content_url('themes/backend/images/logo.png');?>" alt="" />
					</a>			
					...
					<nav class="navbar navbar-default navbar-fixed-top">
							...
							<div class="navbar-brand">
								<ul class="list-inline">
									...
									<li class="list-inline-item">
										<a href="#" class="hidden-md hidden-lg mg-r-15">
											<img class="small-logo" src="<?php echo content_url('themes/backend/images/logo.png');?>" alt="Logo">
										</a>
									</li>
									<li class="list-inline-item">
									...
									<li class="list-inline-item hidden-xs">
										<a href="<?php echo admin_url('post/add');?>" id="sidebar-toggle-button" class="mg-l-15 tx-gray-600">
											<i data-feather="edit" class="wd-20"></i>
										</a>
									</li>
								</ul>
							</div>
						...
						<div class="header-right pull-right">
							<ul class="list-inline justify-content-end">
								...
								<li class="top-link list-inline-item dropdown hidden-xsX" data-toggle="tooltip" data-placement="bottom" title="<?php echo lang_line('menu_comment');?>">
									<a href="<?php echo admin_url('comment');?>" class="message-icon top-link tx-gray-600">
										<i data-feather="message-square" class="wd-20"></i>
										<?php
										if($this->CI->ds_notif('comment') > 0) {
											?>
								...
								<!-- Mail Dropdown Start -->
								<li class="top-link list-inline-item dropdown hidden-xsX" data-toggle="tooltip" data-placement="bottom" title="<?php echo lang_line('menu_mail');?>">
									<a href="<?php echo admin_url('mail');?>" class="notification-icon top-link tx-gray-600">
										<i data-feather="mail" class="wd-20"></i>
										<?php
										if($this->CI->ds_notif('mail') > 0) {
											?>
											<span class="notification-count wave in"></span>
											<?php
										}
								...
								<!--/ Mail Dropdown End -->
								<!-- Go to web -->
								<li class="top-link list-inline-item dropdown hidden-xsX" data-toggle="tooltip" data-placement="bottom" title="<?php echo lang_line('menu_view_web');?>">
									<a href="<?php echo site_url();?>" target="_blank" class="notification-icon top-link tx-gray-600">
										<i data-feather="globe" class="wd-20"></i>
									</a>
								</li>
								<!--/ Go to web -->
								<!-- Profile Dropdown Start -->
								<li class="top-link list-inline-item dropdown">
									<a  href="#" class="top-link top-profile" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
										<img src="<?php echo user_photo(data_login('photo'));?>" class="img-fluid wd-30 ht-30 rounded-circle">
									</a>
									<div class="dropdown-menu dropdown-menu-right dropdown-profile">
										<div class="user-profile-area">
											<div class="user-profile-heading">
												<div class="profile-thumbnail">
													<img src="<?php echo user_photo(data_login('photo'));?>" class="img-fluid wd-35 ht-35 rounded-circle" alt="">
												</div>
												<div class="profile-text">
													<h6><?php echo data_login('name');?></h6>
													<span><?php echo data_login('email');?></span>
												</div>
											</div>
											<a href="<?php echo admin_url('profile')?>" class="dropdown-item">
												<i data-feather="user" class="wd-16 mr-2"></i> <?php echo lang_line('menu_profile');?>
											</a>
											<a href="<?php echo admin_url('profile/edit')?>" class="dropdown-item">
												<i data-feather="edit" class="wd-16 mr-2"></i> <?php echo lang_line('menu_edit_profile');?>
											</a>
											<a href="<?php echo admin_url('setting')?>" class="dropdown-item">
												<i data-feather="settings" class="wd-16 mr-2"></i> <?php echo lang_line('menu_setting');?>
											</a>
											<div class="dropdown-divider"></div>
											<a href="https://web.facebook.com/groups/cifirecms/" target="_blank" class="dropdown-item">
												<i data-feather="life-buoy" class="wd-16 mr-2"></i> <?php echo lang_line('menu_help_center');?>
											</a>
											<a href="<?php echo admin_url('logout')?>" class="dropdown-item">
												<i data-feather="log-out" class="wd-16 mr-2"></i> <?php echo lang_line('menu_logout');?>
											</a>
										</div>
									</div>
								</li>
		...
		<!--/ Scroll To Top End -->
		<!-- Javascript -->
		<script src="<?php echo content_url('plugins/pace/pace.min.js');?>"></script>
		<script src="<?php echo content_url('plugins/feather/feather.min.js');?>"></script>
		<script src="<?php echo content_url('plugins/jquery-ui/jquery-ui.js');?>"></script>
		...
		<script src="<?php echo content_url('plugins/slimscroll/jquery.slimscroll.min.js');?>"></script>
		<script src="<?php echo content_url('plugins/perfect-scrollbar/perfect-scrollbar.js');?>"></script>
		<script src="<?php echo content_url('plugins/datatable/datatables.min.js');?>"></script>
		...
		<script src="<?php echo content_url('plugins/bootstrap-select/bootstrap-select.min.js');?>"></script>
		<script src="<?php echo content_url('plugins/tagsinput/bootstrap-tagsinput.js');?>"></script>
		<script src="<?php echo content_url('plugins/typeahead/typeahead.js');?>"></script>
		<script src="<?php echo content_url('plugins/typeahead/typeahead-active.js');?>"></script>
		...
		<!-- codemirror -->
		<?php 
		if($this->mod == 'theme' || $this->mod == 'setting') {
			?>
		...
		?>
		<!-- admin script -->
		<script src="<?php echo content_url('themes/backend/js/app.js');?>"></script>
		<script src="<?php echo content_url('themes/backend/js/customs.js');?>"></script>
		<!-- Include Modjs -->
		<?php
		if(file_exists(CONTENTPATH . 'modjs/'.$this->mod.'.js')) {
			?>
